...
համապատասխան տվյալների բազայի կոնֆիգուրացիայի համար պետք է ավելացնել նրա կնկնօրինակը փոխելով Service պարամետրի արժեքը հետևյալ կերպ՝ 
 <samp>Service = https://localhost:1027;</samp>
...
```
Local սերվիսով ՀԾ-Բանկ մուտք լինելու համար անհրաժեշտ է նախապես գործարկել այն։
