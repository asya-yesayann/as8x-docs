...
Օգտագործողների կողմից ստեղծված ընդլայնումների ֆայլերը Debug անելիս սովորական եղանակով break point -ի տեղադրումը հնարավոր չէ ելնելով իրագործման եղանակից։ Ծրագրի ընթացքը կանգեցնելու համար առկա են հետևյալ երկու տարբերակը։ 

1. Break point-ի տեղադրում ընդլայնման ֆայլում նկարագրված ընդլայնման հաշվարկի մեթոդը (Calculate, Evaluate) կանչող, տվյալ ֆայլից դուրս գտնվող, հայտարարության (statement) տողի վրա: Նշված հայտարարության տողը գտնելու համար Նշեք մեթոդի անվանումը և սեղմեք Shift + F12 (Find All References). Բացված Evaluate References պատուհանում ընտրեք տյալ տողը կանչող հայտարարությունը, որի արդյունքում կկատարվի անցում համապատասխան ֆայլի պահանջող տողի վրա, որտեղ և տեղադրեք Break Point-ը։ 
    
    

     
3. System.Diagnostics.Debugger.Break(); տողի տեղադրում ընդլայնման ֆայլի այն տողում որտեղ ցանկանում ենք կանգնեցնել ծրագրի կատարումը
