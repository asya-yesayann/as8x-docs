...
Ֆայլում պարունակվող դասը ժառանգում է DocumentExtender [DocumentExtender](document_extender.md) դասը, և կարող է ընդլայնել դասում նկարագրված մեթոդները։ Նշված մեթոդները ավտոմատ կերպով, սահմանված հեթականությամբ կանչվում են փաստաթղթի պահպանման կամ հեռացման ընթացքում։ Մեթոդները որպես պարամետր ստանում են մշակվող փաստաթղթի օբյեկտը, որի միջոցով հնարավոր է մշակման տարբեր փուլերում կատարել լրացված դաշտերի ստուգումներ, ավտոմատ լրացնել դաշտերի, առաջացնել բացառություններ (exceptions) ընդհատելով փաստաթղթի մշակումը, ինչպես նաև ցանկացած այլ գործողություն։  
