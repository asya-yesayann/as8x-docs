...
՝՝՝.as ՝՝՝ ֆայլը պարունակում է տվյալներ ընդլայնվող փաստաթղթի և ներմուծվող ընդլայնման վերաբերյալ։ ```NAME``` պարամետրով սահմանվում է ընդլայնվող փաստաթղթի ներքին անվանումը։ ```CAPTION``` և ```ECAPTION```  պարամետրով սահմանվում է ՀԾ-Բանկ համակարգում արտացոլվող ընդլայնման հայերեն և անգլերեն անվանումները։  ```CSSOURCE``` -ով սահմանում ենք ներմուծվող ```.cs``` ֆայլի անվանումը։ Այն դեպքում երբ SYSCON ծրագրով ներմուծելիս ```.as``` և ```.cs``` ֆայլերը գտնվում են նույն պանակի մեջ սահմանվում է միայն ```.cs``` ֆայլի անվանումը, եթե c# դասը պարունակող ֆայլը գտնվում է այլ պանակում, սահմանվում է   
