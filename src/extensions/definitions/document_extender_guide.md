...
```CAPTION``` և ```ECAPTION```  պարամետրով սահմանվում է ՀԾ-Բանկ համակարգում արտացոլվող ընդլայնման հայերեն և անգլերեն անվանումները (հայերենանվանումը սահմանվում է ANSI կոդավորմամբ)։ 
...
Նախքան Ներմուծումը տեղադրեք ```.as``` ֆայլը config.as ֆայլում սահմանված BASEFOLDER պարամետրով ճանապարհով, այնուհետև գործարկելով SYSCON ծրագիրը ներմուծեք "Նկարագրությունների ներմուծում" հանգույցի ներքո արտացոլվող .as ընդլայնումով ֆայլը։
