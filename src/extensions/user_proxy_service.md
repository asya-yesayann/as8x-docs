...
* `noLock` = Ոչ պարտադիր։ Լռությամբ՝ true: true արժեքի դեպքում հաշվարկը կկատարվի ավելի արագ սակայն հաշվի չեն առնվի ընթացող տրանզակցիաներով փոփոխվող տվյալները։ false արժեքի դեպքում հաշվարկի ժամանակ տվյալների փոփոխման տրանզակցիաների առկայության դեպքում տվյալների ստացումը կկատարվի նրանց ավարտից հետո ապահովվելով նրանց վերջնական վիճակը։ 
