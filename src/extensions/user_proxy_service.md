...
* `curCode` - Ոչ պարտադիր։ Լռությամբ ""։ Սահմանվում է պայմանագրի մնացորդի արժույթը։ Կիրառվում է `convertCur` պարամետրի հետ միասին։ 
...
* `opCur` - Ոչ պարտադիր։ Լռությամբ ""։ Սահմանվում է այն արժույթը, որով կատարվել է գործողությունը։ Կիրառվում է `convertCur` պարամետրի հետ միասին։ Սահմանված չլինելու դեպքում գումարը կվերադարձվի գործողության արժույթով։
* `convertCur` - Ոչ պարտադիր։ Լռությամբ ""։ Վերահաշվակվի արժույթը։ Այս պարամետրը սահմանվում է `opCur` պարամետրի հետ միասին։  Սահմանված չլինելու դեպքում գումարը կվերադարձվի գործողության արժույթով։
