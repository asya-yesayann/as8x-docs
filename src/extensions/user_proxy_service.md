...
* `isn` -  Պարտադիր։ Պայմանագրի ISN։
* `accType` - Պարտադիր։ Հաշվառման կոդ։ Սահմանվում է Subsystems.Enums.Accountings.Rem դասի - ի համապատասխան հատկությունը։ Նշված հատկությունների անվանումները համապատասխանում են [պայմանագրերի հաշվառման կեդերին](#պայմանագրերի-հաշվառումների-կոդեր)։
...
* `curCode` - Ոչ պարտադիր։ Մնացորդի արժույթը։ Լռությամբ՝ ""։ Պարամետրի լռությամբ արժեքի դեպքում մնացորդը կվերադարձվի պայմանագրի արժույթով, հակառակ դեպքում մնացորդը կբաժանվի մնացորդի ամսաթվով սահմանված փոխանցված արժույթի հաշվարկային փոխարժեքով։
