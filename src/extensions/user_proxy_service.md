...
* `agrLevelCheck`- Ոչ պարտադիր։ Հնարավոր արժեքներն են ՝"AGRPARENTS","AGREEMENTS","AGRCHILDREN"։ Լռությամբ՝ ""։ Սահմանված լինելու դեպքում, կստուգվի արդյոք փնտրվող պայմանագիրը համապատասխան մակարդակի է, չբավարարելու դեպքում ֆունկցիան կվերադարձնի -1։
