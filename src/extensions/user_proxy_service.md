...
// Այս տարբերակով տվյալ տիտի հատկություններին կարող ենք դիմել անմիջապես կետից հետո գրելով
...
// (պատասխանատույի անվանում, անձնագրի կոդ)։ Օրինակ՝ "Պողոս Պողոսյան - AA1023065" Ներկայացված է
...
```c#
// Օրինակում բեռնվում է 102711 isn -ով հաճախորդի քարտը կից նկարների հետ։ Այնուհետև ավելացվում է cliPhoto անունով
// պարամետր, որը տպվող ձևի ստեղծման ժամանակ կփոխարինվի հաճախորդի քարտում "Ֆոտոնկար" դաշտում ներբեռնված նկարով։
// Նկարի չափը սահմանելիս օգտագործվող միավորը հավասար է 1 դյույմ / 300 ի։ 1 դյույմը = 2.54 սմ։
...
// ծնող-փասստաթղթի (Բարդ պայմանագիր) isn-ը։ 
...
// պարզել ՀԾ-Բանկ համակարգում տվյալ փաստաթղթի վրա Shift + F3 սեղմելիս, կամ տյալ փաստաթղթի isn-ով
...
Վերադարձնում է հաշվի սահմանափակ դաշտերը (ISN, "Հաշվի համար","Արժույթ","Գրասենյակ","Բաժին","Հասանելիության տիպ") պարունակող օբյեկտ ըսռ հաշվի ISN-ի, երկորդ դեպքում՝ ըստ հաշվի համարի։ 
...
Վերադարձնում է ետհաշվեկշռային հաշվի հիմնական դաշտերը պարունակող օբյետ ըստ ետհաշվեկշռային հաշվի isn-ի, իսկ LoadNBAccountDescByCode ֆունկցիայի դեպքում ըստ հաշվի համարի։ 
...
Հաշվարկում է OLAP ատոմար ցուցանիշ 
...
* `acsBranch`- Պարտադիր։ Հաշվի համար։
* `dateFirst`- Պարտադիր։ Ժամանակաշրջանի սկիզբ այն դեպքում երբ տվյալ ցուցանիշը իրականացվում է որոշակի ժամանակահատվածի համար (օրինակ՝ հաշիվների միջին մնացորդ)։ Ցուցանիշի կողմից մնացորդ վերադարձնելու դեպքում այն հանդիսանում է մնացորդի ամսաթիվը։
* `dateLast`- Պարտադիր։ Ժամանակաշրջանի վերջ ժամանակահատվածի համար ցուցանիշի հաշվարկի դեպքում։ Մնացորդ վերդարձնելու դեպքում այն կանտեսվի։
...
```
Վերադարձնում է ՝parDate՝ պարամետրով փոխանցված ամսաթվին համապատախանող տարվա վերջին օրը, կամ ընթացիկ տարվա վերջին օրը ՝parDate՝ -ը չփոխանցելու դեպքում։

**Պարամետրեր**

* `parDate` - Ոչ պարտադիր։ Ամսաթիվ, որի տարվա վերջին օրը անհրաժեշտ է ստանալ: Լրացված չլինելու դեպքում կվերադարձվի ընթացիկ տարվա վերջին օրը։
