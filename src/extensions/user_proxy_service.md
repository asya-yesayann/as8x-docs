...
* [Հաշվառումների գործողությունների կոդեր](#hաշվառումների-գործողությունների-կոդեր)
...
* `curCode` - Ոչ պարտադիր։ Սահմանվում է պայմանագրի արժույթի կոդը այն դեպքում երբ պայմանագիրը դրամային չէ և անհրաժեշտ է մնացորդը վերահաշվարկել ըստ տվյալ արժույթի համար սահմանված հաշվարկաին փոխարժեքի։ Լռությամբ՝ ""։ 
