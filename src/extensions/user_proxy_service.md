...
* `isn` -  Պարտադիր։ Պայմանագրի ISN։
* `accType` - Պարտադիր։ Հաշվառման կոդ։ Սահմանվում է Subsystems.Enums.Accountings.Rem դասի - ի համապատասխան հատկությունը։ Նշված հատկությունների անվանումները համապատասխանում են [արժեքը](#պայմանագրերի-հաշվառումների-կոդերին)։
