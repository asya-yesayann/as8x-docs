...
/* Հաշվարկվում է 28/01/2024-ին նախորդող տոկոսադրույքի վերանայման ամսաթիվը։ Տվյալ դեպքում անտեսում ենք ֆունկցիայի կողմից    վերադարձվող գործողության ժամը, որը հասանելի է միայն հետևյալ գործողությունների դեպքում (LIM - Սահմանաչափ, DUA - Պայմանագրի ժամկետ, PNE - Բանկի արդյունավետ տոկոսադրույք)։ */
