...
```c#
// LoadDoc ֆունկցիայի վերադարձրած արժեքը հնարավոր է բերել վերադարձվող փաստաթղթի տիպի (Տարբերակ 2)։ Այս տարբերակում ունենք հնարավորություն դիմել տվյալ տիտի հատկություններին անմիջապես կետից հետո գրելով հատկության անվանումը (cli2.ADDRESS)։ Առաջին տարբերակի դեպքում հատկության անվանումը փոխանցվում է որպես տող (clientDocument2["ADDRESS"])։ Նշվածը կարող է հարմար լինել երբ հատկության անվանումը անհրաժեշտ է փոխանցել փոփոխականի միջոցով, որը դեպքերից կախված կարող է տարբեր արժեք ունենալ։ 
...
**Աշխատանք նկարների և մեմոների հետ**
```c#
// Բերված օրինակում բեռնվում է 102711 isn -ով հաճախորդի քարտը կից նկարների հետ։ Այնուհետև ավելացվում է cliPhoto անունով
