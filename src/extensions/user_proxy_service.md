...
* `dateFirst`- Ոչ պարտադիր։ Ժամանակաշրջանի սկիզբ այն դեպքում երբ տվյալ ցուցանիշը իրականացվում է որոշակի ժամանակահատվածի համար (օրինակ՝ հաշիվների միջին մնացորդ)։ Ցուցանիշի կողմից մնացորդ վերադարձնելու դեպքում այն հանդիսանում է մնացորդի ամսաթիվը։
* `dateLast`- Ոչ պարտադիր։ Ժամանակաշրջանի վերջ ժամանակահատվածի համար ցուցանիշի հաշվարկի դեպքում։ Մնացորդ վերադարձնելու դեպքում այն կանտեսվի։
