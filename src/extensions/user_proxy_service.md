...
* `opCur` - Ոչ պարտադիր։ Լռությամբ ""։ Գործողության կատրման արժությը։ Կիրառվում է `convertCur` պարամետրի հետ միասին։ Սահմանված չլինելու դեպքում գումարը կվերադարձվի գործողության արժույթով։
