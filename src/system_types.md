...
Տիպի նոր օբյեկտ ստեղծելու համար անհրաժեշտ է կանչել [FieldTypeProvider](/src/field_type_provider.md) ստատիկ դասի [GetNumPairFieldType](/src/field_type_provider.md#getnumpairfieldtype) մեթոդը։
