...
Վերադարձնում է փաստաթղթին [կցված ֆայլի նկարագրությունը](AttachmentModel.md) տվյալների պահոցի [DOCSATTACH](https://armsoft.github.io/as4x-docs/HTM/ProgrGuide/Database/DocsAttach.html) աղյուսակից՝ ըստ ֆայլի անվան և փաստաթղթի ներքին նույնականացման համարի (isn)։
...
Վերադարձնում է փաստաթղթին բոլոր [կցված ֆայլերի նկարագրությունները](AttachmentModel.md) տվյալների պահոցի [DOCSATTACH](https://armsoft.github.io/as4x-docs/HTM/ProgrGuide/Database/DocsAttach.html) աղյուսակում։
...
* `attachment` - [Կցված ֆայլի թարմացված նկարագրությունը](AttachmentContentModel.md)։
