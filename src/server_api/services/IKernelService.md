...
Վերադարձնում է`
* `CRem` - Հաշվառում օբյեկտի մնացորդը դրամային արտարժույթով։
* `NCRem` - Հաշվառում օբյեկտի մնացորդը հաշվի արտարժույթով։
...
Վերադարձնում է հաշվառում օբյեկտի մնացորդը [HI2](https://armsoft.github.io/as4x-docs/HTM/ProgrGuide/Database/Hi2.html) դրամային (`CRem`) և արտարժույթային (`NCRem`) հաշվառումների համար նշված ամսաթվի դրությամբ։ Մնացորդը կա՛մ գումարային ըստ բոլոր կուտակող օբյեկտների է, կամ միայն `isnGl`-ով փոխանցվածի։
...
* `DbTurn` - Հաշվառող օբյեկտի դեբետային շրջանառության արժեքը արտարժույթով։
* `DbTurnAMD` - Հաշվառող օբյեկտի դեբետային շրջանառության արժեքը դրամային արտարժույթով։
* `CrTurn` - Հաշվառող օբյեկտի կրեդիտային շրջանառության արժեքը արտարժույթով։
...
* `CrTurn` - Հաշվառող օբյեկտի կրեդիտային շրջանառության արժեքը արտարժույթով։
* `DbTurnAMD` - Հաշվառող օբյեկտի կրեդիտային շրջանառության արժեքը դրամային արտարժույթով։
* `Rem` - Հաշվառում օբյեկտի վերջնական մնացորդը  դրամային արտարժույթով։
* `RemAMD` - Հաշվառում օբյեկտի վերջնական մնացորդը հաշվի արտարժույթով։
* `StartRem` - Հաշվառում օբյեկտի սկզբնական մնացորդը դրամային արտարժույթով։
* `NCRem` - Հաշվառում օբյեկտի մնացորդը հաշվի արտարժույթով։
...
Ի տարբերություն LastOpDate մեթոդի, այս մեթոդը կարող է ֆիլտրել ներառող կամ բացառող գործողությունների կոդերով։

**Պարամետրեր**

* `accountings` - Հաշվառման կոդ (ներքին անուն):
* `isn` - Հաշվառման օբյեկտի ներքին նույնականացման համար։
* `upToDate` - Ամսաթիվը, մինչև որը կատարվում է որոնումը։ Եթե պարամետրը տրված չէ, ապա վերադառնում է տվյալ հաշվառման մեջ վերջին գործառույթի ամսաթիվը։
...
* `accCodes` - Հաշվառման կոդերի զանգված:
* `isn` - Հաշվառման օբյեկտի ներքին նույնականացման համար։
* `glIsn` - Կուտակող օբյեկտի ներքին նույնականացման համար։
* `upToDate` - Ամսաթիվը, մինչև որը կատարվում է որոնումը։ Եթե պարամետրը տրված չէ, ապա վերադառնում է տվյալ հաշվառման մեջ վերջին գործառույթի ամսաթիվը։
* `op` - Հաշվառման գործողություն, որով անցկացվում է որոնումը։
